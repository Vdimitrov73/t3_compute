...
The wizard will ask you for:
  ...
  5. Brokerage account(s) and any mid-year transfers

If you don't have an ACB spreadsheet yet, the wizard
will copy the template (acb_worksheet_template.xlsx)
for you. Open it and read the README sheet first.
...
Download from:
  ...
  2025 and later:
    save as  VBAL_T3_2025.pdf  in <base_dir>\2025\

  2024 and earlier:
    save as  VBAL_T3_2024.xls  in <base_dir>\2024\

STEP 4 — Enter your Buy/Sell transactions
------------------------------------------
Open your ACB spreadsheet and make sure all Buy/Sell
transactions for the tax year are entered before
...
From the main menu, run each step in order:
  ...
  Step 2 — Update ACB spreadsheet (*** run --dry-run
            first to preview changes safely ***)
  Step 3 — Build assets
...
SmartScreen warning ("Windows protected your PC"):
  ...
  (~$500 USD/year). To avoid this entirely, install
  from the Microsoft Store (Canadian Store only —
  search T3 Compute). The tool is open source — you
  can inspect every line of code on GitLab.
...
tax advice. Always cross-check computed totals against
your official T3 slips and consult a tax professional
if in doubt.
